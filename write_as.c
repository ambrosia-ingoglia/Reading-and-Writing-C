 ...
 */
//Biggest challenge was not being able to find the quote in the asynchronous_output.txt file
#include <stdio.h>
#include <errno.h>
#include <sys/types.h>
#include <sys/stat.h>
...
int main(int argc, char *argv[])
{
	...
	//prints each character of my name to 'stdout' over and over again 
	fprintf(stdout, "Doing something while waiting.\n");
	char name[8] = ("Ambrosia");
